...
public class Location {
    ...
    @Test
    public void cssSelectoreqaulAttributeOrStartAttributeWithQuotes2() {
        driver.get("https://catalog.onliner.by/acs_photo");
        driver.findElement(By.xpath("div[@class='header-style__divider']"));  // <div class="header-style__divider"></div>

    }


    // Test 12 By.xpath("//tag[@attribute='value']")
    // <div id="schema-scroll-to"></div>
    @Test
    public void xpathSearchByAttribute() {
        driver.get("https://catalog.onliner.by/acs_photo");
        driver.findElement(By.xpath("//div[@id='schema-scroll-to']")); // <div id="schema-scroll-to"></div>
    }


    // Test 13 By.xpath("//tag[contains(@attribute,'text')]");
    // <div id="schema-scroll-to"></div>
    @Test
    public void xpathSearchByAttributePart() {
        driver.get("https://catalog.onliner.by/acs_photo");
        driver.findElement(By.xpath("//div[contains(@id,'schema')]")); // <div id="schema-scroll-to"></div>
    }


    // Test 14 tagname (находит много локаторов)
    @Test
    public void cssTagname() {
        driver.get("https://catalog.onliner.by/acs_photo");
        driver.findElement(By.cssSelector("div")); // <div id="schema-scroll-to"></div>
    }

    // Test 15 <header class="g-top">
    // tagname.class
    @Test
    public void cssTagnameClass() {
        driver.get("https://catalog.onliner.by/acs_photo");
        driver.findElement(By.cssSelector("header.g-top"));
    }

    // Test 16 [class="g-container-outer"]
    // [attribute=value]
    @Test
    public void cssTagnameAttributeValue() {
        driver.get("https://catalog.onliner.by/acs_photo");
        driver.findElement(By.cssSelector("[class='g-container-outer']"));
    }

    // ПОВТОР xpath поиск по атрибуту
    // //div[@class="header-style__aside"]
    @Test
    public void searchByAttribute3() {
        driver.get("https://catalog.onliner.by/acs_photo");
        driver.findElement(By.xpath("//div[@class='header-style__aside']"));
    }

    // Test 17
    // //div[@class="header-style__aside"]//descendant::div
    @Test
    public void searchByAttribute4() {
        driver.get("https://catalog.onliner.by/acs_photo");
        driver.findElement(By.xpath("//div[@class='header-style__aside']//descendant::div"));
    }

    // Test 18 //div[@class="header-style__aside"]//descendant::div//following::a

    @Test
    public void searchByAttribute5() {
        driver.get("https://catalog.onliner.by/acs_photo");
        driver.findElement(By.xpath("//div[@class='header-style__aside']//descendant::div//following::a"));
    }


    // Test 19 //div[@class="header-style__aside"]//parent::div

    @Test
    public void searchByAttribute6() {
        driver.get("https://catalog.onliner.by/acs_photo");
        driver.findElement(By.xpath("//div[@class='header-style__aside']//parent::div"));
    }


    //Test 20 input[@class='_2zrpKA _1dBPDZ' and @type='text']
    // //script[@type="text/html" and @id="schema-filter-template__help"]
    @Test
    public void searchByAttribute7() {
        driver.get("https://catalog.onliner.by/acs_photo");
        driver.findElement(By.xpath("//script[@type='text/html' and @id='schema-filter-template__help']"));
    }
}
